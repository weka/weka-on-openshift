# Deploying a WEKA cluster on OpenShift

This README explains the steps required to deploy a wekaCluster on OpenShift.

Use `install-weka-on-ocp.sh` to deploy a `wekaCluster`. 
